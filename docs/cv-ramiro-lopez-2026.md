...
Ingeniero en Sistemas Computacionales con más de 9 años de experiencia en desarrollo fullstack, coordinación de proyectos de software y aseguramiento de calidad en sectores gubernamental, financiero y fintech. Especializado en ASP.NET Core, ASP.NET MVC, Vue.js 3 y SQL Server, con dominio de Clean Architecture, Entity Framework Core, JWT, Docker y AWS. Orientado a entregar software robusto y mantenible bajo metodologías ágiles, con sólida experiencia trabajando tanto en el stack backend (.NET) como en el frontend moderno (Vue.js, JavaScript, jQuery).

---

## HABILIDADES TÉCNICAS

**Backend:** ASP.NET Core | ASP.NET MVC | .NET 10 | C# | LINQ | Entity Framework Core | JWT | APIs REST | Swagger/OpenAPI

**Frontend:** Vue.js 3 (Composition API, Pinia, Vue Router) | JavaScript ES6+ | jQuery | HTML5 | CSS3 | Bootstrap

**Bases de datos:** SQL Server | T-SQL | MongoDB | EF Core Migrations | Consultas LINQ avanzadas

**DevOps & Cloud:** AWS (Elastic Beanstalk, S3, RDS, IAM) | Docker | GitHub Actions CI/CD | IIS

**Arquitectura:** Clean Architecture | Repository Pattern | Unit of Work | DDD | Middleware personalizado

**Metodologías:** Scrum | ITIL Foundation | ISO/IEC 20000 | Coordinación de equipos

**Testing:** xUnit (pruebas unitarias) | QA Manual | Diseño y ejecución de planes de prueba
...
- Automaticé CI/CD con GitHub Actions ejecutando 23 pruebas unitarias (xUnit, patrón AAA) en cada push a las ramas `main` y `desarrollo`.
- Desplegué en AWS: API en Elastic Beanstalk con Docker multi-stage build, frontend estático en S3 con política de mínimo privilegio (PoLP) en IAM.
...
**Ingeniero en Sistemas Computacionales** | ESCOM — Instituto Politécnico Nacional | Titulado — Cédula Profesional
